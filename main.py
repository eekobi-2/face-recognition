...
imgElon = face_recognition.load_image_file('images/dhoni1jpg')
imgElon = cv2.cvtColor(imgElon, cv2.COLOR_BGR2RGB)
imgTest = face_recognition.load_image_file('images/kohli1.jpg')
...
cv2.imshow('dhoni1', imgdhoni)
cv2.imshow('dhoni2', imgTest)
cv2.waitKey(0)